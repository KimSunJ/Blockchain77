...
// 실핼을 최소화하기 위해서 변수에 반환값(return)을 정의하여 이후 다시 찾지 않고 바로 쓸수 있도록 한다.

function deleteItem(num) {
  // 삭제를 위한 함수
  list.children[num].classList.add("delete");
  //  list의 자식들(Element) 중에 num 번째 자식에 'delete'라는 클래스를 추가한다.
  // delete 클래스를 가진 엘리먼트는 css 스타일로 인해 가운데 줄
  //   let startIdx = 0;
  //   let endIdx = 0;
  //   // 어디서부터 어디까지 자를 건지 구현
