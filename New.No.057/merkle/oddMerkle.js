...
const createMerkleRoot = (_data) => {
  ...
  // return을 객체로 내보내는 이유 : 블록 생성 후 해당 블록이 정상적인 블록인지 확인하기 위해서 객체로 내보낸다.(블록 안 내용이 키와 값으로 되어 있어야 찾기 쉽기 때문에 객체로 내보낸다.)
  //  isError를 통해서 생성 도중 문제가 발생했는지를 먼저 파악할 수 있다.
